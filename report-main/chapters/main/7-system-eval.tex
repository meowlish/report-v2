...
\begin{itemize}
    ...
    \item \textbf{NFR2 --- Scalability:} hệ thống xử lý thành công hơn 255.000 request với 1.000 VU đồng thời, tỷ lệ check pass đạt 100\% cho public endpoints và trên 98\% cho các endpoint yêu cầu xác thực. Mặc dù chưa đạt đến mốc 10.000 concurrent user do giới hạn tài nguyên VPS hiện tại, kết quả cho thấy kiến trúc microservices cho phép mở rộng khi bổ sung thêm tài nguyên.
