...
\end{itemize}
\end{minipage} \\ \hline
FR4 & Learning Consultant Chatbot & Nền tảng phải cung cấp một conversational AI interface có khả năng phân tích user performance, xác định điểm yếu, tạo các câu hỏi luyện tập có mục tiêu và đưa ra personalized study guidance. \\ \hline
FR5 & Speaking Simulation & Nền tảng phải cung cấp các phiên luyện Speaking chân thực, sử dụng Whisper cho voice input, deepfake-generated examiners để tăng tính trực quan và các câu hỏi được điều chỉnh dựa trên câu trả lời của người dùng. \\ \hline
FR6 & Knowledge Management & Người dùng phải có thể tạo các bộ flashcard, lưu vocabulary và grammar item, ghi chú trong quá trình luyện tập và tổ chức tài liệu học tập thành các custom collection. \\ \hline
...
\begin{itemize}
  ...
  \item  AI Chatbot Service: Chịu trách nhiệm cho AI Chatbot của hệ thống.
\end{itemize}
