...
\item \textbf{Khó mở rộng}: Chấm điểm thủ công và hướng dẫn cá nhân hóa không dễ mở rộng để phục vụ số lượng lớn người học.
...
\begin{enumerate}
    ...
    \item \textbf{Cá nhân hóa việc học:} Điều chỉnh lộ trình học theo điểm mạnh và điểm yếu của từng người học. Thông qua phân tích mẫu kết quả, nền tảng có thể tập trung vào những phần người học còn yếu để giúp cải thiện nhanh hơn.
    
    \item \textbf{Luyện tập tương tác:} Cung cấp các bài luyện Nói, Nghe và Viết sát với điều kiện thi thực tế. Người học có thể tăng sự tự tin và độ thành thạo khi luyện tập trong môi trường mô phỏng bài thi thật.
    
    \item \textbf{Hướng dẫn tức thời:} Cung cấp phản hồi và giải đáp kịp thời khi người học cần hỗ trợ. Trợ lý AI có thể giải thích thắc mắc, gợi ý tài nguyên học tập và hỗ trợ ra quyết định trong quá trình học.
...
Người dùng chính của hệ thống là người Việt Nam đang chuẩn bị cho các kỳ thi đánh giá năng lực tiếng Anh như IELTS, TOEFL, TOEIC và SAT. Phiên bản hiện tại chưa mở rộng đến nhóm đối tượng là tổ chức, giảng viên hay nhân sự quản trị học vụ.

\subsection{Môi trường vận hành}

Ứng dụng được định hướng vận hành hoàn toàn trực tuyến và có thể truy cập thông qua trình duyệt web trên máy tính để bàn và thiết bị di động. Dự án không giới hạn ở một khu vực địa lý cụ thể mà giả định môi trường sử dụng có kết nối Internet phổ thông.

\subsection{Thời gian thực hiện}

Phạm vi của dự án bao gồm các hoạt động được thực hiện trong thời gian học phần được giao, gồm phân tích yêu cầu, thiết kế hệ thống, hiện thực, kiểm thử và triển khai. Bảo trì dài hạn, vận hành thương mại và mở rộng tính năng trong tương lai không nằm trong phạm vi của đề tài.

\subsection{Giới hạn kỹ thuật}

Hệ thống sử dụng Next.js \cite{nextjs_docs} cho giao diện người dùng, NestJS \cite{nestjs} cho phát triển API phía máy chủ, MongoDB \cite{mongodb} và PostgreSQL \cite{postgresql} cho lưu trữ dữ liệu, FastAPI \cite{fastapi} cho các thành phần AI và AWS \cite{aws} cho hạ tầng đám mây. Đề tài chỉ tập trung vào việc tích hợp các mô hình hoặc API AI có sẵn; việc huấn luyện hay tinh chỉnh các mô hình AI lớn tùy biến không thuộc phạm vi thực hiện.

\subsection{Ràng buộc}

Dự án được thực hiện trong bối cảnh học thuật nên chịu các ràng buộc điển hình như thời gian phát triển hạn chế, tài nguyên tính toán có giới hạn và yêu cầu hệ thống phải phù hợp với năng lực triển khai của nhóm bốn thành viên. Vì vậy, tăng cường bảo mật ở mức sản phẩm thương mại, cấu hình sẵn sàng cao và tối ưu hiệu năng cấp production không phải là mục tiêu chính.


\section{Kết luận chương}
Chương này đã trình bày bài toán ôn luyện tiếng Anh chuẩn hóa với những hạn chế của các phương pháp và nền tảng hiện có. Từ đó, nhóm xác định mục tiêu xây dựng một nền tảng tích hợp AI nhằm hỗ trợ nhiều kỳ thi, cá nhân hóa lộ trình học tập, cung cấp phản hồi tức thì cho kỹ năng Nói và Viết, đồng thời theo dõi tiến độ người học. Phạm vi dự án được giới hạn rõ ràng về đối tượng, thời gian, công nghệ và ràng buộc tài nguyên để đảm bảo tính khả thi trong bối cảnh học thuật.
