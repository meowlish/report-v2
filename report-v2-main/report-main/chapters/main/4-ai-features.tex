...
Lingriser được tổ chức theo mô hình Client--Server phân tầng rõ ràng. Frontend (Next.js) giao tiếp với Backend (NestJS) qua REST API. Backend đóng vai trò điều phối trung tâm: xử lý nghiệp vụ, xác thực JWT, và gọi các dịch vụ bên ngoài. Lớp AI được tách hoàn toàn khỏi logic nghiệp vụ, giao tiếp với OpenAI API qua SDK chính thức thông qua \texttt{AIPracticeService}.
