...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/LingriserSpeaking/speaking-landing.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/profile/profile-progress.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/chat/chat.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/admin/admin-dashboard.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/admin/exam-management.jpg}
    \captionsetup{skip=5pt}
...
\subsubsection{Blog Management}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/admin/blog-management.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/admin/user-management.jpg}
    \captionsetup{skip=5pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{graphics/ui/admin/norify-management.jpg}
    \captionsetup{skip=5pt}
